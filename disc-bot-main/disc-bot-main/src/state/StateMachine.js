...
const STATES = {
    // Initial state when a bet is discovered
    ...
    // NEW: Two-stage confirmation (Master Prompt REQ 3)
    WAITING_FOR_OPPONENT_CONFIRM: 'WAITING_FOR_OPPONENT_CONFIRM',
...
const TRANSITIONS = {
    ...
    [STATES.WAITING_FOR_DEPOSIT_ADDRESS]: [STATES.PAYMENT_SENT, STATES.AWAITING_GAME_START, STATES.GAME_IN_PROGRESS, STATES.CANCELLED],
    [STATES.PAYMENT_SENT]: [STATES.WAITING_FOR_BET_CONFIRMATION, STATES.AWAITING_GAME_START, STATES.GAME_IN_PROGRESS, STATES.CANCELLED],
    ...
    // NEW: Two-stage confirmation flow (Master Prompt REQ 3)
    [STATES.WAITING_FOR_OPPONENT_CONFIRM]: [STATES.AWAITING_PAYMENT_ADDRESS, STATES.WAITING_FOR_DEPOSIT_ADDRESS, STATES.CANCELLED],
    ...
    [STATES.AWAITING_MIDDLEMAN]: [STATES.AWAITING_PAYMENT_ADDRESS, STATES.WAITING_FOR_DEPOSIT_ADDRESS, STATES.WAITING_FOR_OPPONENT_CONFIRM, STATES.CANCELLED],
    [STATES.AWAITING_PAYMENT_ADDRESS]: [STATES.PAYMENT_SENT, STATES.AWAITING_GAME_START, STATES.WAITING_FOR_OUR_TURN, STATES.GAME_IN_PROGRESS, STATES.CANCELLED, STATES.AWAITING_MIDDLEMAN],
    [STATES.WAITING_FOR_DEPOSIT_ADDRESS]: [STATES.PAYMENT_SENT, STATES.AWAITING_GAME_START, STATES.GAME_IN_PROGRESS, STATES.CANCELLED],
