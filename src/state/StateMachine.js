...
const TRANSITIONS = {
    ...
    // Flow Fix: Allow direct transition to GAME_IN_PROGRESS for Auto-Dice
    [STATES.PAYMENT_SENT]: [STATES.AWAITING_GAME_START, STATES.GAME_IN_PROGRESS, STATES.CANCELLED],
